...
public class OrderAPI extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class AddRegTokenToProfile extends OrderAPIRequest<Void> {
    ...
    protected AddRegTokenToProfile(java.lang.String profileID, java.lang.String profileType, java.lang.String regToken) {
      super(OrderAPI.this, "POST", REST_PATH, null, Void.class);
   ...
   *
   * @param content the {@link com.appspot.tayyar_trial.orderAPI.model.DeliveryRequest}
   * @return the request
   */
  public SendDeliveryRequest sendDeliveryRequest(com.appspot.tayyar_trial.orderAPI.model.DeliveryRequest content) throws java.io.IOException {
    SendDeliveryRequest result = new SendDeliveryRequest(content);
    initialize(result);
    return result;
  }

  public class SendDeliveryRequest extends OrderAPIRequest<java.lang.Object> {
     ...
     * @since 1.13
     */
    protected SendDeliveryRequest(com.appspot.tayyar_trial.orderAPI.model.DeliveryRequest content) {
      super(OrderAPI.this, "POST", REST_PATH, content, java.lang.Object.class);
    }
  ...
  public class SendNotificationByID extends OrderAPIRequest<java.lang.Object> {
    ...
    protected SendNotificationByID(java.lang.String message, java.lang.String profileID, java.lang.String profileType) {
      super(OrderAPI.this, "POST", REST_PATH, null, java.lang.Object.class);
  ...
  /**
   * Create a request for the method "sendNotificationByRegToken2".
   *
   * This request holds the parameters needed by the orderAPI server.  After setting any optional
   * parameters, call the {@link SendNotificationByRegToken2#execute()} method to invoke the remote
   * operation.
   *
   * @param amess
   * @param zregTok
   * @return the request
   */
  public SendNotificationByRegToken2 sendNotificationByRegToken2(java.lang.String amess, java.lang.String zregTok) throws java.io.IOException {
    SendNotificationByRegToken2 result = new SendNotificationByRegToken2(amess, zregTok);
    initialize(result);
    return result;
  }

  public class SendNotificationByRegToken2 extends OrderAPIRequest<com.appspot.tayyar_trial.orderAPI.model.RestaurantView> {

    private static final String REST_PATH = "sendNotificationByRegToken2";

    /**
     * Create a request for the method "sendNotificationByRegToken2".
     *
     * This request holds the parameters needed by the the orderAPI server.  After setting any
     * optional parameters, call the {@link SendNotificationByRegToken2#execute()} method to invoke
     * the remote operation. <p> {@link SendNotificationByRegToken2#initialize(com.google.api.client.g
     ...
     * @since 1.13
     */
    protected SendNotificationByRegToken2(java.lang.String amess, java.lang.String zregTok) {
      super(OrderAPI.this, "GET", REST_PATH, null, com.appspot.tayyar_trial.orderAPI.model.RestaurantView.class);
      this.amess = com.google.api.client.util.Preconditions.checkNotNull(amess, "Required parameter amess must be specified.");
      this.zregTok = com.google.api.client.util.Preconditions.checkNotNull(zregTok, "Required parameter zregTok must be specified.");
    }
    ...
    @Override
    public SendNotificationByRegToken2 setAlt(java.lang.String alt) {
      return (SendNotificationByRegToken2) super.setAlt(alt);
    }

    @Override
    public SendNotificationByRegToken2 setFields(java.lang.String fields) {
      return (SendNotificationByRegToken2) super.setFields(fields);
    }

    @Override
    public SendNotificationByRegToken2 setKey(java.lang.String key) {
      return (SendNotificationByRegToken2) super.setKey(key);
    }

    @Override
    public SendNotificationByRegToken2 setOauthToken(java.lang.String oauthToken) {
      return (SendNotificationByRegToken2) super.setOauthToken(oauthToken);
    }

    @Override
    public SendNotificationByRegToken2 setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (SendNotificationByRegToken2) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public SendNotificationByRegToken2 setQuotaUser(java.lang.String quotaUser) {
      return (SendNotificationByRegToken2) super.setQuotaUser(quotaUser);
    }

    @Override
    public SendNotificationByRegToken2 setUserIp(java.lang.String userIp) {
      return (SendNotificationByRegToken2) super.setUserIp(userIp);
    }

    @com.google.api.client.util.Key
    private java.lang.String amess;

    /**

     */
    public java.lang.String getAmess() {
      return amess;
    }

    public SendNotificationByRegToken2 setAmess(java.lang.String amess) {
      this.amess = amess;
      return this;
    }

    @com.google.api.client.util.Key
    private java.lang.String zregTok;

    /**

     */
    public java.lang.String getZregTok() {
      return zregTok;
    }

    public SendNotificationByRegToken2 setZregTok(java.lang.String zregTok) {
      this.zregTok = zregTok;
      return this;
    }

    @Override
    public SendNotificationByRegToken2 set(String parameterName, Object value) {
      return (SendNotificationByRegToken2) super.set(parameterName, value);
    }
  }
